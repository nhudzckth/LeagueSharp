...
namespace PerplexedOrianna
{
     class Updater
    {
        ...
        {
            return new BetterWebClient(null).DownloadString("https://raw.githubusercontent.com/Perplexity/LeagueSharp/master/PerplexedOrianna/PerplexedOrianna/version/version.txt");
        }
    }
}
