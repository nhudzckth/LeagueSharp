...
namespace PerplexedLucian
{
     class Updater
    {
        ...
        {
            return new BetterWebClient(null).DownloadString("https://raw.githubusercontent.com/Perplexity/LeagueSharp/master/PerplexedLucian/PerplexedLucian/version/version.txt");
        }
    }
}
